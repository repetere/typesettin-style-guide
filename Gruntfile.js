...
module.exports = function (grunt) {
	grunt.initConfig({
		...
		jsbeautifier: {
			files: ['<%= jshint.all %>', '!resources/template/typesettin_style_guide.ejs'],
			options: {
				config: '.jsbeautify'
			}
		},
		...
		less: {
			development: {
				...
				files: {
					'example/stylesheets/typesettin-style-guide.css': 'resources/stylesheets/typesettin-style-guide.less',
